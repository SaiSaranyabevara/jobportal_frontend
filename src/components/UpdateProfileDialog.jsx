...
import { Dialog,DialogTitle, DialogContent, DialogFooter, DialogHeader, DialogDescription } from './ui/dialog'
            ...
            <Dialog open={open}>
                <DialogContent className={"sm:max-w-[425px]" } onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
        You can update your profile details below. Make sure everything is accurate before saving.
      </DialogDescription>
                    </DialogHeader>
                    <form onSubmit={submitHandler}>
                        ...
                        <DialogFooter>
                        {   loading ? <Button className={"w-full my-4 cursor-pointer"}><Loader2 className='mr-2 h-4 w-4 animate-spin' />Please Wait</Button> : <Button type="submit" className={"w-full my-4 cursor-pointer"} >Update</Button>}
